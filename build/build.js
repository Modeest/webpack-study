...
/**
 *
 * npm run build	构建测试环境包
npm run build -- --modern	构建测试环境 legacy 和 modern 包
npm run build -- --env prod	构建线上环境包
npm run build -- --env prod --modern	构建线上环境 legacy 和 modern 包
 */